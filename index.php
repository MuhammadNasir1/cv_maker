  ...
  <footer class="text-center text-lg-start text-white" style="background-color: black">
    <!-- <section class="d-flex justify-content-between  p-3 " style="background-color: #C21010">
      <div class="me-5  ">
        <span class=" mt-2">Get connected with us on social networks:</span>
      </div>

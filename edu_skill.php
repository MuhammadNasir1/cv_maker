              ...
              <div class="form-info">
                ...
                <div id="addeduction">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="input-field mt-5 ">
                          <textarea name="edu_field[]" class="hide" id="Feild" style="width: 85%; border-radius: 5px; height:40px" id=""></textarea>
                          <a id="" class="educationbtn"> <img data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add Education" class="float-end" src="./image/plus-icon.svg" alt=""></a>
                ...
                <script>
                  ...
                  $(".educationbtn").on('click', function(event) {
                    ...
                    $("#education_table").append('<div class="row" id="education_table_id_' + id + '">\
                    <div class="col-md-6">\
                        <div class="input-field mt-5 ">\
                          <input class="rem_value hide" name=""   type="text"> <label > Institute Name </label>\
                        </div>\
                    </div>\
                    <div class="col-md-6">\
                        <div class="input-field mt-5 ">\
                    ...
                    <div class="col-md-6 ">\
                      ...
                      <a onclick="removeById(`#education_table_id_' + id + '`)"<i style="color: #C21010;letter-spacing: 0.2rem;cursor: pointer; text-decoration: none;"class="bx bx-trash-alt"></i></a>\
                    </div>')
                ...
                <!-- ======================details-table================ -->
                <div id="educ_table_hide" class="container-fluid">
